...
public class TppCustomerDataService : ITppCustomerDataService
{
    ...
    public TppCustomerDataService(DataSharingLogger logger, BalanceDbContext postbalanceDbContext, IOptions<StoredProcedureParams> storedProcedureParams, IDbConnection idbConnection)
    {
        _logger = logger;
    ...
    public async Task<List<CustomerResponse>> FetchCutomerDetailsResponse(Guid correlationId)
    {
        ...
        {
            _logger.Error(ex, "Error fetching customer details");
    ...
    private async Task<CustomerDataRequest> GetTppCustomerMakeDetails(Guid CorrelationId)
    {
        ...
        {
            _logger.Error(ex, "Error in GetTppCustomerMakeDetails");
    ...
    private async Task<List<CustomerDataRequest>> GetTppCustomerMakerList(string User)
    {
        ...
        {
            _logger.Error(ex, "Error in GetTppCustomerList");
        }
        return makerList;
    }
    private async Task<List<CustomerDataRequest>> MapDbcontenttoModel(List<CustomerRequest> dbContent)
    {
        ...
        {
            _logger.Error(ex, "Error in MapDbcontenttoModel");
        }
        return result;
    }
    ...
    {
        _logger.Info("GetAllTppCustomerAsync started.");
        ...
        catch (Exception ex)
        {
            ...
            _logger.Error(ex, "Error while fetching GetAllTppCustomerAsync");
            return new List<TppCustomerDetailDto>();
        }
        _logger.Info("GetAllTppCustomerAsync fetched successfully.");
    ...
    {
        _logger.Info("GetTppCustomerByDateAsync started.");
        List<TppCustomerDetailDto> tppCustomerDetailDto = new List<TppCustomerDetailDto>();
        try
        {
            var parameters = new DynamicParameters();
        ...
        {
            _logger.Error(ex, "Error while fetching GetTppCustomerByDateAsync");
            return new List<TppCustomerDetailDto>();
        }
        _logger.Info("GetTppCustomerByDateAsync fetched successfully.");
        return tppCustomerDetailDto;
    }

    public async Task<TppCustomerDetailDto> GetTppCustomerByIdAsync(Guid CorrelationId)
    {
        _logger.Info("GetTppCustomerByIdAsync started.");
        ...
        catch (Exception ex)
        {
            ...
            _logger.Error(ex, "Error while fetching GetTppCustomerByIdAsync");
            return new TppCustomerDetailDto();
        }
        _logger.Info("GetTppCustomerByIdAsync fetched successfully.");
        return tppCustomerDetailDto;
    }
