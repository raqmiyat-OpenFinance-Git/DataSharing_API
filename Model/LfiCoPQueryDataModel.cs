...
{
    public class LfiCoPQueryDataModel
    {
        public List<LfiCoPQueryData>? lfiCoPQueryDatas { get; set; }

        public LfiCoPQueryData? lfiCoPQueryData { get; set; }
    }
    public class LfiCoPQueryData
    {

        public long LfiCopQueryRequestId { get; set; }  // bigint IDENTITY(1,1)
