namespace OpenFinance.Models.TPP
{
    public class TppCreateLeadModel
    {
        public List<TppLeadModel>? LeadModelList { get; set; }
        public TppLeadModel? LeadModel { get; set; }

    }
    public class TppLeadModel
    {
