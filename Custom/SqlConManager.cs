...
public static class SqlConManager
{
    public static string GetConnectionString(string _connectionString, bool IsEncrypted)
    {
        try
        {
            ...
            string modifiedConnectionString = $"Data Source={dataSource};Initial Catalog={initialCatalog};User ID={userId};password={password};Application Name={applicationName};MultipleActiveResultSets=True;TrustServerCertificate=True;";
